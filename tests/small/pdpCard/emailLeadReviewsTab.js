const basePdpPath = '/apartments/Alaska/Yakutat/The-Grand-at-Dunwoody/100022110/#reviews'
...
const userBeds = '2'
const userBaths = '2'
const userMessage = `Lead submission for ${listingNameEnglish} from Reviews tab, accessed by going to tab directly via URL\nListing ID: ${listingId}` // eslint-disable-line max-len
