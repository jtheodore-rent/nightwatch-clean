module.exports = {
  ...
  before: browser => {
    browser
      ...
      .waitForURLEquals(`${browser.launchUrl}/senior/`)
  ...
  'Validate header': browser => {
    browser.page.large.header().validate(`${browser.launchUrl}/`, 'Senior', false)
  },

  'Validate page content': browser => {
    const content = browser.page.large.seniorLander()
